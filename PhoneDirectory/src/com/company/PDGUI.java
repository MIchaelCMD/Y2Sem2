    ...
    private class ButtonHandler implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == nextButton) {
                ...
                String result = phoneDirectory.search(name);
                if(result == null)
                    JOptionPane.showMessageDialog(null,"The name: " + name + " was not found");
                else
                    JOptionPane.showMessageDialog(null,"The number for " + name + " is " + result);
